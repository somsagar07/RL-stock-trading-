...
def update_plot():
  ...
  # Clear the entire cell output before re-plotting
  clear_output(wait=True)

  plt.figure(figsize=(10,6))
  plt.plot(prices, label=tickerSymbol, marker='o')
  plt.legend()
  plt.xlabel('Updates')
  plt.ylabel('Time')
  plt.title(f'{current_price}')
...
SEARCH_TERM = 'AMZN'
rss_url = 'https://news.google.com/rss/search?q=' + SEARCH_TERM + '&hl=en-US&gl=US&ceid=US:en'
